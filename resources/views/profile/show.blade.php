<x-app-layout>
    ...
    <header class="relative">
        ...
        <div class="flex text-sm mt-3 mb-3">
            <a href="{{ route('followers', $user->username) }}" class="hover:underline"><strong>{{ $user->followers()->count() }}</strong> Followers</a>
            <a href="/profiles/{{ $user->username }}/following" class="ml-2 hover:underline"><strong>{{ $user->following()->count() }}</strong> Following</a>
        </div>
